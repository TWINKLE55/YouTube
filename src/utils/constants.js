export const API_KEY = "AIzaSyCsYteXj2qTXD1RG3U3MXz2qQmb-A_riBc";
...
export const Video_api = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=4&regionCode=IN&key=${API_KEY}`;
